...
public interface WebBoardRepository extends CrudRepository<WebBoard, Long>, QuerydslPredicateExecutor<WebBoard>{
	...
	@Query("SELECT b.bno, b.title, b.writer, b.regdate, count(r) FROM WebBoard b "
			+ "LEFT OUTER JOIN b.replies r WHERE b.title like %?1% b.bno > 0 GROUP BY b")
	public List<Object[]> getListWithTitle(String keyword, Pageable page);
	
	@Query("SELECT b.bno, b.title, b.writer, b.regdate, count(r) FROM WebBoard b "
			+ "LEFT OUTER JOIN b.replies r WHERE b.content like %?1% b.bno > 0 GROUP BY b")
	public List<Object[]> getListWithContent(String keyword, Pageable page);
	
	@Query("SELECT b.bno, b.title, b.writer, b.regdate, count(r) FROM WebBoard b "
			+ "LEFT OUTER JOIN b.replies r WHERE b.writer like %?1% b.bno > 0 GROUP BY b")
